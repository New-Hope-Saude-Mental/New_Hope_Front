    ...
    <div>
        <div class="d-flex justify-content-center">
            ...
            <div class="" style="max-width: 80rem; margin-top: 80px;">
                ...
                <p class="text-start">
                    O equilíbrio psicológico é de extrema importância para a população em geral. Refere-se ao comportamento
                    emocional e psicossocial de um indivíduo. A forma de lidar com frustrações e desafios diários depende do
                    seu
                    equilíbrio emocional, fundamental para sentir-se bem, elevando a qualidade de vida. Estar saudável
                    mentalmente
                    significa que somos mais capazes de nos conectar, funcionar, lidar com o cotidiano e prosperar. Porém,
                    muitas
                    vezes há um desequilíbrio emocional, e podemos passar de uma plenitude mental para estados debilitantes
                    de
                    grande sofrimento e dor emocional. Fatores individuais, familiares, comunitários e estruturais podem
                    influenciar
                    na saúde emocional, de forma construtiva ou destrutiva. As pessoas que vivenciam isso correm maior risco
                    de
                    experimentar problemas no bem-estar mental.
                    <br />
                    <br />
                    Existem diversos transtornos e condições relacionados à saúde mental, como a ansiedade e a depressão.
                    Esses
                    transtornos podem afetar o humor, o comportamento e a capacidade de lidar com as demandas cotidianas.
                    Trata-se
                    de um estado de higidez mental em que uma pessoa é capaz de realizar suas atividades diárias de forma
                    produtiva,
                    lidar com o estresse normalmente, ter relacionamentos saudáveis e contribuir para a comunidade. Existem
                    muitos
                    casos em que a hospitalização resulta em um malefício na mentalidade e no comportamento do indivíduo,
                    gerando
                    ansiedade e depressão, e quanto maior o tempo que o paciente permanece no hospital maior a probabilidade
                    do
                    desenvolvimento dessas complicações.
                    <br />
                    <br />
                    Além disso, lesões traumáticas podem gerar um estresse pós-traumático, devido à situação causada. E
                    também,
                    a
                    depressão pode vir acompanhada desse estresse, gerando outros sintomas, como por exemplo, ansiedade,
                    raiva,
                    sentimentos de inutilidade, etc. Ademais, o tempo de internação na UTI e nos hospitais aumentam os
                    fatores
                    psiquiátricos negativos, causando mais estresse. Este mau funcionamento psiquiátrico pode levar a
        ...
        <div class="d-flex justify-content-center mt-5">
            ...
            <div class="ms-5 d-flex justify-content-center">
                ...
                <img src="../assets//img/Corredor.jpg" alt="" style="max-height: 22rem;">
            </div>
        </div>
        <div class="d-flex justify-content-center mt-5">
            <div class="me-5 d-flex justify-content-center">

                <img src="../assets/img/montanha.png" alt="" style="max-height: 22rem;">
            </div>
            <div class="d-flex align-content-center flex-wrap ms-5" style="max-width: 40rem;">

                <p class="fs text-start">
                    Alguns pacientes desenvolvem mecanismos de enfrentamento para lidar com a hospitalização, enquanto
        ...
        <div class="d-flex justify-content-center mt-5">
            <div class="d-flex align-content-center flex-wrap me-5" style="max-width: 40rem;">
                ...
                <p class="fs text-start">
                    O planejamento cuidadoso da alta hospitalar, com instruções claras sobre cuidados de acompanhamento e
                    apoio emocional, é fundamental para a transição suave do paciente de volta à sua vida cotidiana.
                </p>
            </div>
            <div class="ms-5 d-flex justify-content-center">

                <img src="../assets/img/medica.jpg" alt="" style="max-height: 22rem;">
            </div>
        </div>
        <div class="d-flex justify-content-center mt-5">
            <div class="me-5 d-flex justify-content-center">

                <img src="../assets/img/academia.png" alt="" style="max-height: 22rem;">
            </div>
            <div class="d-flex align-content-center flex-wrap ms-5" style="max-width: 40rem;">

                <p class="fs text-start">
                    Então, é muito importante cuidar tanto da saúde mental, quanto da saúde física em todos os casos, para
