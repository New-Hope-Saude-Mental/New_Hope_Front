        ...
        <div class="">
            ...
            <div class="mt-5" style="max-width: 60rem; font-size: large;">
                ...
                <p class="text-start">
                    ...
                    transtorno de estresse pós-traumático, transtorno de adaptação, transtornos alimentares, transtorno do
                    sono-vigília, transtornos de personalidade e transtornos aditivos. Atualmente, a doença mental que tem
                    predominado com mais frequência é a depressão. A ansiedade também tem aumentado, assim como quadros
                    ...
                    exemplo, as
                    alucinações e o medo podem levá-lo a um comportamento agressivo; do mesmo modo como um paciente
                    depressivo,
                    que
                    sente que sua vida perdeu o sentido, pode pensar em cometer suicídio. Por isso, não temos como
                    classificar
                    um ou
                    outro transtorno como mais grave. Sempre que um paciente procura por uma consulta psiquiátrica,
                    independente
                    do
                    ...
                    outras
                    situações como a epidemia que estamos enfrentando hoje. Pela minha experiência clínica, quando
                    implantávamos
                    ambulatório de saúde mental, percebíamos o quanto a procura para o atendimento se tornava crescente. O
                    ...
                    tempo
                    todo, que são demasiadamente preocupadas; outras com um sofrimento psíquico muito grande, acarretando
                    uma
                    angústia profunda, perda ou aumento descontrolado do apetite, desespero, quando a pessoa não quer sair
                    de
                    casa e
                    evita o convívio social, choro sem motivo aparente, irritabilidade, ‘explosão’ ou mau humor, problemas
                    de
                    esquecimento; pensamento delirante e alucinações. As causas para um transtorno mental podem ser
                    exógenas, ou
                    seja, devido a um acontecimento que desencadeou um trauma ou estresse, e podem também ser endógenas,
                    devido
                    a
                    uma alteração química no organismo. O paciente, quando busca atendimento dizendo “Doutor, estou
                    deprimido,
                    mas
                    na minha vida está tudo bem, não aconteceu nada de ruim”, ele próprio não identifica um motivo aparente
                    para
                    o
                    estado depressivo.
                    <br>
                    ...
                    reinventar,
                    para fazer essa travessia de maneira menos angustiante, ou menos entediante. Lembrando Machado de
                    Assis*: A
                    pena
                    da galhofa, tingida pela tinta da melancolia. Importante mencionar que o medo da contaminação pelo
                    coronavírus
                    tem feito parte do nosso cotidiano, mas o medo é uma emoção também necessária e saudável,
                    propiciando-nos um
                    contato maior com a “real” natureza da realidade que nos ameaça. O medo nos põe em contato com nossa
                    extrema
                    vulnerabilidade, fragilidade e finitude. Ele é benéfico na medida em que nos impele a nos protegermos, a
                    tomarmos os cuidados necessários durante a pandemia. Então, no sentido tolerável, cabível, o medo atua
                    como
                    uma
                    proteção.
                    ...
                    compreender que a doença mental existe, que pode acometer qualquer indivíduo e que deve ser vista como
                    qualquer
                    outra doença, passível de tratamento. Doença mental não é para ser negada, mas para ser vista e cuidada!
                    Temos
                    que fazer o tratamento, multiprofissional, efetivo, baseado nas evidências, sem estigma, sem
                    preconceito,
                    com o
                    devido acolhimento a cada paciente.
                </p>
            </div>
